...
<div class="content">
    <div class="container_12" style="margin-top:30px">
        ...
        <table id="table1">
            <thead>
                <tr>
                    <td colspan="5"><h2> SURE BETS SUBSCRIPTION PRICES </h2></td>
                </tr>
            </thead>
        </table>
        ...
        <div class="grid_3">
            <a href="" class="banner">
                ...
                <div class="ban">
                    <div class="ban1">
                        <span></span>
                        <div class="title">Ksh 50.00</div>
                        <strong>Daily Premium Tips</strong>
                    </div>
                </div>
            </a>
        </div>
        <div class="grid_3">
            <a href="" class="banner">
                ...
                <div class="ban">
                    <div class="ban1">
                        <span></span>
                        <div class="title">Ksh 200.00</div>
                        <strong>Weekend Jackpots</strong>
                    </div>
                </div>
            </a>
        </div>
        <div class="grid_3">
            <a href="" class="banner">
                ...
                <div class="ban">
                    <div class="ban1">
                        <span></span>
                        <div class="title">Ksh 250.00</div>
                        <strong>Weekend Tips and Jackpots</strong>
                    </div>
                </div>
            </a>
        </div>
        <div class="grid_3">
            <a href="" class="banner">
                ...
                <div class="ban">
                    <div class="ban1">
                        <span></span>
                        <div class="title">Ksh 299.00</div>
                        <strong>Weekly Premium Tips</strong>
                    </div>
                </div>
            </a>
        </div>
        <div class="grid_3">
            <a href="" class="banner">
                ...
                <div class="ban">
                    <div class="ban1">
                        <span></span>
                        <div class="title">Ksh 400.00</div>
                        <strong>Weekly Premium and Jackpots</strong>
                    </div>
                </div>
            </a>
        </div>
        <div class="grid_3">
            <a href="" class="banner">
                ...
                <div class="ban">
                    <div class="ban1">
                        <span></span>
                        <div class="title">Ksh 650.00</div>
                        <strong>Monthly Jackpots Tips</strong>
                    </div>
                </div>
            </a>
        </div>
        <div class="grid_3">
            <a href="" class="banner">
                ...
                <div class="ban">
                    <div class="ban1">
                        <span></span>
                        <div class="title">Ksh 1,000.00</div>
                        <strong>Monthly Premium Tips</strong>
                    </div>
                </div>
            </a>
        </div>
        <div class="grid_3">
            <a href="" class="banner">
                ...
                <div class="ban">
                    <div class="ban1">
                        <span></span>
                        <div class="title">Ksh 1,500.00</div>
                        <strong>Monthly Premium and Jackpots</strong>
                    </div>
                </div>
            </a>
        </div>
